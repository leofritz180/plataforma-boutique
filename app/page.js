          ...
          <div className="flex items-end justify-between mb-8 md:mb-10">
            <div>
              ...
              <p className="section-subtitle">
                Os queridinhos que não param de sair
              </p>
            </div>
            <Link href="/" className="hidden md:inline-flex items-center gap-1 text-xs tracking-widest uppercase font-medium text-brand-dark hover:text-brand-pink-dark transition-colors">
              Ver tudo
        ...
        <div className="container-custom pt-16 md:pt-24">
          <div className="flex items-end justify-between mb-8 md:mb-10">
            <div>
              ...
              <p className="section-subtitle">
                Acabou de chegar e já está fazendo sucesso
              </p>
            </div>
            <Link href="/" className="hidden md:inline-flex items-center gap-1 text-xs tracking-widest uppercase font-medium text-brand-dark hover:text-brand-pink-dark transition-colors">
              Ver tudo
        ...
        <div className="container-custom py-14 md:py-20">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="text-center md:text-left">
              <span className="inline-block text-xs tracking-[0.3em] uppercase text-brand-pink font-medium mb-3">
                Só esta semana
              </span>
              ...
              <Link href="/" className="inline-block px-10 py-4 bg-white text-brand-dark text-sm font-medium tracking-widest uppercase hover:bg-brand-pink-light transition-colors">
                Ver ofertas
              </Link>
            </div>
        ...
        <section className="py-16 md:py-24">
          <div className="container-custom">
            <div className="flex items-end justify-between mb-8 md:mb-10">
              <div>
                <h2 className="section-title">
                  Promoções <span className="italic font-light text-red-500">imperdíveis</span> 🏷️
                </h2>
                <p className="section-subtitle">
        ...
        <section className="py-16 md:py-24 bg-brand-nude-light/50">
          <div className="container-custom">
            <div className="text-center mb-8 md:mb-10">
              ...
              <p className="section-subtitle">
                As peças mais amadas da nossa loja
              </p>
            </div>

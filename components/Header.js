    ...
    <>
        ...
        <div className="container-custom">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <Link href="/" className="flex-shrink-0">
              <h1 className="font-display text-xl md:text-2xl tracking-tight text-brand-dark">
            ...
            <div className="flex items-center gap-1 md:gap-3">
              ...
              >
                ...
                <span className="absolute -top-0.5 -right-0.5 bg-brand-dark text-white text-2xs w-4.5 h-4.5 flex items-center justify-center rounded-full font-medium text-[10px] min-w-[18px] h-[18px]">
                  0
                </span>
              </button>
            </div>
            ...
            <div className="container-custom py-4">
              <div className="relative">
                <input
                  ...
                  className="w-full py-3 pl-12 pr-4 border border-gray-200 rounded-none text-sm focus:outline-none focus:border-brand-dark transition-colors"
                  autoFocus
                />
      ...
      {menuOpen && (
        <>
          ...
          />
          <div className="fixed top-0 left-0 bottom-0 w-80 max-w-[85vw] bg-white z-50 lg:hidden animate-slide-in overflow-y-auto">
            {/* Cabeçalho do menu */}
            ...
            <nav className="p-6">
              {navLinks.map((link) => (
                <Link
                  ...
                  href={link.href}
                  onClick={() => setMenuOpen(false)}
                  className={`block py-3 text-sm tracking-widest uppercase font-medium border-b border-gray-100 transition-colors ${

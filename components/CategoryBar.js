      ...
      <div className="container-custom">
        <div className="flex gap-4 md:gap-6 overflow-x-auto scrollbar-hide pb-2 -mx-4 px-4 md:mx-0 md:px-0 md:justify-center md:flex-wrap">
          {categories.map((cat) => (
            ...
            >
              <div className="w-16 h-16 md:w-20 md:h-20 bg-brand-nude-light rounded-full flex items-center justify-center text-brand-charcoal group-hover:bg-brand-pink-light group-hover:text-brand-dark transition-all group-hover:scale-105 transform duration-200">
                {cat.icon}
              </div>
